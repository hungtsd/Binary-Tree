import {DrawContextCfg} from './config.js';
...
export class DrawContext{
    ...
    constructor(canvas: HTMLCanvasElement, canvasSize: Partial<CanvasSize> = {}){
        this.#canvas = canvas;
        this.#ctx = canvas.getContext('2d') as CanvasRenderingContext2D;
        this.#size = mergeObj(DrawContextCfg.defaultSize, canvasSize);
