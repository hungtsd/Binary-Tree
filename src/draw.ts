...
export class DrawContext{
    ...
    circle(cord : any, r : number, border_width : number, border_col : string, inner_col : string) : void{
        this.ctx.beginPath();
    ...
    line(cord1 : any, cord2 : any, col : string, width : number) : void{
    ...
    text(cord : any, text : string, size : number) : void{
